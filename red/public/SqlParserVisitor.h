...
class SqlParserVisitor : public SqlBaseParserVisitor
{
private:
    /* data */
public:
    SqlParserVisitor(/* args */);
    ~SqlParserVisitor();

    std::any visitCompoundOrSingleStatement(SqlBaseParser::CompoundOrSingleStatementContext *context);

    std::any visitSingleCompoundStatement(SqlBaseParser::SingleCompoundStatementContext *context);

    std::any visitBeginEndCompoundBlock(SqlBaseParser::BeginEndCompoundBlockContext *context);

    std::any visitCompoundBody(SqlBaseParser::CompoundBodyContext *context);

    std::any visitCompoundStatement(SqlBaseParser::CompoundStatementContext *context);

    std::any visitSetVariableWithOptionalKeyword(SqlBaseParser::SetVariableWithOptionalKeywordContext *context);

    std::any visitSqlStateValue(SqlBaseParser::SqlStateValueContext *context);

    std::any visitDeclareConditionStatement(SqlBaseParser::DeclareConditionStatementContext *context);
    ...
    std::any visitDeclareHandlerStatement(SqlBaseParser::DeclareHandlerStatementContext *context);
    ...
    std::any visitIterateStatement(SqlBaseParser::IterateStatementContext *context);

    std::any visitSearchedCaseStatement(SqlBaseParser::SearchedCaseStatementContext *context);

    std::any visitSimpleCaseStatement(SqlBaseParser::SimpleCaseStatementContext *context);
    ...
    std::any visitSingleExpression(SqlBaseParser::SingleExpressionContext *context);

    std::any visitSingleTableIdentifier(SqlBaseParser::SingleTableIdentifierContext *context);

    std::any visitSingleMultipartIdentifier(SqlBaseParser::SingleMultipartIdentifierContext *context);

    std::any visitSingleFunctionIdentifier(SqlBaseParser::SingleFunctionIdentifierContext *context);

    std::any visitSingleDataType(SqlBaseParser::SingleDataTypeContext *context);

    std::any visitSingleTableSchema(SqlBaseParser::SingleTableSchemaContext *context);

    std::any visitStatementDefault(SqlBaseParser::StatementDefaultContext *context);

    std::any visitVisitExecuteImmediate(SqlBaseParser::VisitExecuteImmediateContext *context);
    ...
    std::any visitSetNamespaceProperties(SqlBaseParser::SetNamespacePropertiesContext *context);

    std::any visitUnsetNamespaceProperties(SqlBaseParser::UnsetNamespacePropertiesContext *context);

    std::any visitSetNamespaceLocation(SqlBaseParser::SetNamespaceLocationContext *context);
    ...
    std::any visitRenameTableColumn(SqlBaseParser::RenameTableColumnContext *context);

    std::any visitDropTableColumns(SqlBaseParser::DropTableColumnsContext *context);

    std::any visitRenameTable(SqlBaseParser::RenameTableContext *context);

    std::any visitSetTableProperties(SqlBaseParser::SetTablePropertiesContext *context);

    std::any visitUnsetTableProperties(SqlBaseParser::UnsetTablePropertiesContext *context);

    std::any visitAlterTableAlterColumn(SqlBaseParser::AlterTableAlterColumnContext *context);

    std::any visitHiveChangeColumn(SqlBaseParser::HiveChangeColumnContext *context);

    std::any visitHiveReplaceColumns(SqlBaseParser::HiveReplaceColumnsContext *context);

    std::any visitSetTableSerDe(SqlBaseParser::SetTableSerDeContext *context);

    std::any visitAddTablePartition(SqlBaseParser::AddTablePartitionContext *context);

    std::any visitRenameTablePartition(SqlBaseParser::RenameTablePartitionContext *context);

    std::any visitDropTablePartitions(SqlBaseParser::DropTablePartitionsContext *context);

    std::any visitSetTableLocation(SqlBaseParser::SetTableLocationContext *context);

    std::any visitRecoverPartitions(SqlBaseParser::RecoverPartitionsContext *context);

    std::any visitAlterClusterBy(SqlBaseParser::AlterClusterByContext *context);

    std::any visitAlterTableCollation(SqlBaseParser::AlterTableCollationContext *context);

    std::any visitAddTableConstraint(SqlBaseParser::AddTableConstraintContext *context);

    std::any visitDropTableConstraint(SqlBaseParser::DropTableConstraintContext *context);
    ...
    std::any visitCreateTempViewUsing(SqlBaseParser::CreateTempViewUsingContext *context);

    std::any visitAlterViewQuery(SqlBaseParser::AlterViewQueryContext *context);

    std::any visitAlterViewSchemaBinding(SqlBaseParser::AlterViewSchemaBindingContext *context);

    std::any visitCreateFunction(SqlBaseParser::CreateFunctionContext *context);

    std::any visitCreateUserDefinedFunction(SqlBaseParser::CreateUserDefinedFunctionContext *context);
    ...
    std::any visitShowTableExtended(SqlBaseParser::ShowTableExtendedContext *context);

    std::any visitShowTblProperties(SqlBaseParser::ShowTblPropertiesContext *context);
    ...
    std::any visitShowCurrentNamespace(SqlBaseParser::ShowCurrentNamespaceContext *context);

    std::any visitShowCatalogs(SqlBaseParser::ShowCatalogsContext *context);

    std::any visitDescribeFunction(SqlBaseParser::DescribeFunctionContext *context);

    std::any visitDescribeProcedure(SqlBaseParser::DescribeProcedureContext *context);

    std::any visitDescribeNamespace(SqlBaseParser::DescribeNamespaceContext *context);

    std::any visitDescribeRelation(SqlBaseParser::DescribeRelationContext *context);

    std::any visitDescribeQuery(SqlBaseParser::DescribeQueryContext *context);

    std::any visitCommentNamespace(SqlBaseParser::CommentNamespaceContext *context);
    ...
    std::any visitFailNativeCommand(SqlBaseParser::FailNativeCommandContext *context);
    ...
    std::any visitSetQuotedConfiguration(SqlBaseParser::SetQuotedConfigurationContext *context);

    std::any visitSetConfiguration(SqlBaseParser::SetConfigurationContext *context);

    std::any visitResetQuotedConfiguration(SqlBaseParser::ResetQuotedConfigurationContext *context);

    std::any visitResetConfiguration(SqlBaseParser::ResetConfigurationContext *context);

    std::any visitExecuteImmediate(SqlBaseParser::ExecuteImmediateContext *context);

    std::any visitExecuteImmediateUsing(SqlBaseParser::ExecuteImmediateUsingContext *context);

    std::any visitExecuteImmediateQueryParam(SqlBaseParser::ExecuteImmediateQueryParamContext *context);

    std::any visitExecuteImmediateArgument(SqlBaseParser::ExecuteImmediateArgumentContext *context);

    std::any visitExecuteImmediateArgumentSeq(SqlBaseParser::ExecuteImmediateArgumentSeqContext *context);
    ...
    std::any visitUnsupportedHiveNativeCommands(SqlBaseParser::UnsupportedHiveNativeCommandsContext *context);

    std::any visitCreateTableHeader(SqlBaseParser::CreateTableHeaderContext *context);

    std::any visitReplaceTableHeader(SqlBaseParser::ReplaceTableHeaderContext *context);
    ...
    std::any visitInsertOverwriteTable(SqlBaseParser::InsertOverwriteTableContext *context);

    std::any visitInsertIntoTable(SqlBaseParser::InsertIntoTableContext *context);

    std::any visitInsertIntoReplaceWhere(SqlBaseParser::InsertIntoReplaceWhereContext *context);

    std::any visitInsertOverwriteHiveDir(SqlBaseParser::InsertOverwriteHiveDirContext *context);

    std::any visitInsertOverwriteDir(SqlBaseParser::InsertOverwriteDirContext *context);

    std::any visitPartitionSpecLocation(SqlBaseParser::PartitionSpecLocationContext *context);
    ...
    std::any visitDescribeFuncName(SqlBaseParser::DescribeFuncNameContext *context);
    ...
    std::any visitCreateTableClauses(SqlBaseParser::CreateTableClausesContext *context);
    ...
    std::any visitExpressionPropertyList(SqlBaseParser::ExpressionPropertyListContext *context);

    std::any visitExpressionProperty(SqlBaseParser::ExpressionPropertyContext *context);

    std::any visitConstantList(SqlBaseParser::ConstantListContext *context);

    std::any visitNestedConstantList(SqlBaseParser::NestedConstantListContext *context);

    std::any visitCreateFileFormat(SqlBaseParser::CreateFileFormatContext *context);

    std::any visitTableFileFormat(SqlBaseParser::TableFileFormatContext *context);

    std::any visitGenericFileFormat(SqlBaseParser::GenericFileFormatContext *context);
    ...
    std::any visitSingleInsertQuery(SqlBaseParser::SingleInsertQueryContext *context);

    std::any visitMultiInsertQuery(SqlBaseParser::MultiInsertQueryContext *context);
    ...
    std::any visitIdentifierReference(SqlBaseParser::IdentifierReferenceContext *context);

    std::any visitCatalogIdentifierReference(SqlBaseParser::CatalogIdentifierReferenceContext *context);

    std::any visitQueryOrganization(SqlBaseParser::QueryOrganizationContext *context);

    std::any visitMultiInsertQueryBody(SqlBaseParser::MultiInsertQueryBodyContext *context);

    std::any visitOperatorPipeStatement(SqlBaseParser::OperatorPipeStatementContext *context);

    std::any visitQueryTermDefault(SqlBaseParser::QueryTermDefaultContext *context);

    std::any visitSetOperation(SqlBaseParser::SetOperationContext *context);

    std::any visitQueryPrimaryDefault(SqlBaseParser::QueryPrimaryDefaultContext *context);

    std::any visitFromStmt(SqlBaseParser::FromStmtContext *context);

    std::any visitTable(SqlBaseParser::TableContext *context);

    std::any visitInlineTableDefault1(SqlBaseParser::InlineTableDefault1Context *context);
    ...
    std::any visitFromStatementBody(SqlBaseParser::FromStatementBodyContext *context);

    std::any visitTransformQuerySpecification(SqlBaseParser::TransformQuerySpecificationContext *context);

    std::any visitRegularQuerySpecification(SqlBaseParser::RegularQuerySpecificationContext *context);
    ...
    std::any visitNotMatchedClause(SqlBaseParser::NotMatchedClauseContext *context);

    std::any visitNotMatchedBySourceClause(SqlBaseParser::NotMatchedBySourceClauseContext *context);

    std::any visitMatchedAction(SqlBaseParser::MatchedActionContext *context);

    std::any visitNotMatchedAction(SqlBaseParser::NotMatchedActionContext *context);

    std::any visitNotMatchedBySourceAction(SqlBaseParser::NotMatchedBySourceActionContext *context);
    ...
    std::any visitAggregationClause(SqlBaseParser::AggregationClauseContext *context);

    std::any visitGroupByClause(SqlBaseParser::GroupByClauseContext *context);

    std::any visitGroupingAnalytics(SqlBaseParser::GroupingAnalyticsContext *context);
    ...
    std::any visitUnpivotNullClause(SqlBaseParser::UnpivotNullClauseContext *context);

    std::any visitUnpivotOperator(SqlBaseParser::UnpivotOperatorContext *context);

    std::any visitUnpivotSingleValueColumnClause(SqlBaseParser::UnpivotSingleValueColumnClauseContext *context);

    std::any visitUnpivotMultiValueColumnClause(SqlBaseParser::UnpivotMultiValueColumnClauseContext *context);

    std::any visitUnpivotColumnSet(SqlBaseParser::UnpivotColumnSetContext *context);

    std::any visitUnpivotValueColumn(SqlBaseParser::UnpivotValueColumnContext *context);

    std::any visitUnpivotNameColumn(SqlBaseParser::UnpivotNameColumnContext *context);

    std::any visitUnpivotColumnAndAlias(SqlBaseParser::UnpivotColumnAndAliasContext *context);
    ...
    std::any visitRelationExtension(SqlBaseParser::RelationExtensionContext *context);
    ...
    std::any visitSampleByPercentile(SqlBaseParser::SampleByPercentileContext *context);
    ...
    std::any visitOrderedIdentifierList(SqlBaseParser::OrderedIdentifierListContext *context);

    std::any visitOrderedIdentifier(SqlBaseParser::OrderedIdentifierContext *context);

    std::any visitIdentifierCommentList(SqlBaseParser::IdentifierCommentListContext *context);

    std::any visitIdentifierComment(SqlBaseParser::IdentifierCommentContext *context);
    ...
    std::any visitInlineTableDefault2(SqlBaseParser::InlineTableDefault2Context *context);

    std::any visitTableValuedFunction(SqlBaseParser::TableValuedFunctionContext *context);
    ...
    std::any visitFunctionTableSubqueryArgument(SqlBaseParser::FunctionTableSubqueryArgumentContext *context);

    std::any visitTableArgumentPartitioning(SqlBaseParser::TableArgumentPartitioningContext *context);

    std::any visitFunctionTableNamedArgumentExpression(SqlBaseParser::FunctionTableNamedArgumentExpressionContext *context);

    std::any visitFunctionTableReferenceArgument(SqlBaseParser::FunctionTableReferenceArgumentContext *context);

    std::any visitFunctionTableArgument(SqlBaseParser::FunctionTableArgumentContext *context);
    ...
    std::any visitRowFormatDelimited(SqlBaseParser::RowFormatDelimitedContext *context);

    std::any visitMultipartIdentifierList(SqlBaseParser::MultipartIdentifierListContext *context);

    std::any visitMultipartIdentifier(SqlBaseParser::MultipartIdentifierContext *context);

    std::any visitMultipartIdentifierPropertyList(SqlBaseParser::MultipartIdentifierPropertyListContext *context);

    std::any visitMultipartIdentifierProperty(SqlBaseParser::MultipartIdentifierPropertyContext *context);

    std::any visitTableIdentifier(SqlBaseParser::TableIdentifierContext *context);

    std::any visitFunctionIdentifier(SqlBaseParser::FunctionIdentifierContext *context);

    std::any visitNamedExpression(SqlBaseParser::NamedExpressionContext *context);

    std::any visitNamedExpressionSeq(SqlBaseParser::NamedExpressionSeqContext *context);

    std::any visitPartitionFieldList(SqlBaseParser::PartitionFieldListContext *context);

    std::any visitPartitionTransform(SqlBaseParser::PartitionTransformContext *context);

    std::any visitPartitionColumn(SqlBaseParser::PartitionColumnContext *context);

    std::any visitIdentityTransform(SqlBaseParser::IdentityTransformContext *context);

    std::any visitApplyTransform(SqlBaseParser::ApplyTransformContext *context);

    std::any visitTransformArgument(SqlBaseParser::TransformArgumentContext *context);

    std::any visitExpression(SqlBaseParser::ExpressionContext *context);

    std::any visitNamedArgumentExpression(SqlBaseParser::NamedArgumentExpressionContext *context);

    std::any visitFunctionArgument(SqlBaseParser::FunctionArgumentContext *context);
    ...
    std::any visitErrorCapturingNot(SqlBaseParser::ErrorCapturingNotContext *context);

    std::any visitValueExpressionDefault(SqlBaseParser::ValueExpressionDefaultContext *context);
    ...
    std::any visitArithmeticBinary(SqlBaseParser::ArithmeticBinaryContext *context);
    ...
    std::any visitParenthesizedExpression(SqlBaseParser::ParenthesizedExpressionContext *context);
    ...
    std::any visitSubqueryExpression(SqlBaseParser::SubqueryExpressionContext *context);
    ...
    std::any visitPosParameterLiteral(SqlBaseParser::PosParameterLiteralContext *context);

    std::any visitNamedParameterLiteral(SqlBaseParser::NamedParameterLiteralContext *context);
    ...
    std::any visitComparisonOperator(SqlBaseParser::ComparisonOperatorContext *context);

    std::any visitArithmeticOperator(SqlBaseParser::ArithmeticOperatorContext *context);

    std::any visitPredicateOperator(SqlBaseParser::PredicateOperatorContext *context);
    ...
    std::any visitErrorCapturingMultiUnitsInterval(SqlBaseParser::ErrorCapturingMultiUnitsIntervalContext *context);

    std::any visitMultiUnitsInterval(SqlBaseParser::MultiUnitsIntervalContext *context);

    std::any visitErrorCapturingUnitToUnitInterval(SqlBaseParser::ErrorCapturingUnitToUnitIntervalContext *context);

    std::any visitUnitToUnitInterval(SqlBaseParser::UnitToUnitIntervalContext *context);

    std::any visitIntervalValue(SqlBaseParser::IntervalValueContext *context);

    std::any visitUnitInMultiUnits(SqlBaseParser::UnitInMultiUnitsContext *context);

    std::any visitUnitInUnitToUnit(SqlBaseParser::UnitInUnitToUnitContext *context);
    ...
    std::any visitYearMonthIntervalDataType(SqlBaseParser::YearMonthIntervalDataTypeContext *context);

    std::any visitDayTimeIntervalDataType(SqlBaseParser::DayTimeIntervalDataTypeContext *context);

    std::any visitPrimitiveDataType(SqlBaseParser::PrimitiveDataTypeContext *context);

    std::any visitQualifiedColTypeWithPositionList(SqlBaseParser::QualifiedColTypeWithPositionListContext *context);

    std::any visitQualifiedColTypeWithPosition(SqlBaseParser::QualifiedColTypeWithPositionContext *context);

    std::any visitColDefinitionDescriptorWithPosition(SqlBaseParser::ColDefinitionDescriptorWithPositionContext *context);

    std::any visitDefaultExpression(SqlBaseParser::DefaultExpressionContext *context);

    std::any visitVariableDefaultExpression(SqlBaseParser::VariableDefaultExpressionContext *context);
    ...
    std::any visitTableElementList(SqlBaseParser::TableElementListContext *context);

    std::any visitTableElement(SqlBaseParser::TableElementContext *context);

    std::any visitColDefinitionList(SqlBaseParser::ColDefinitionListContext *context);

    std::any visitColDefinition(SqlBaseParser::ColDefinitionContext *context);

    std::any visitColDefinitionOption(SqlBaseParser::ColDefinitionOptionContext *context);
    ...
    std::any visitSequenceGeneratorOption(SqlBaseParser::SequenceGeneratorOptionContext *context);

    std::any visitSequenceGeneratorStartOrStep(SqlBaseParser::SequenceGeneratorStartOrStepContext *context);

    std::any visitComplexColTypeList(SqlBaseParser::ComplexColTypeListContext *context);

    std::any visitComplexColType(SqlBaseParser::ComplexColTypeContext *context);

    std::any visitRoutineCharacteristics(SqlBaseParser::RoutineCharacteristicsContext *context);
    ...
    std::any visitQualifiedNameList(SqlBaseParser::QualifiedNameListContext *context);
    ...
    std::any visitErrorCapturingIdentifier(SqlBaseParser::ErrorCapturingIdentifierContext *context);
    ...
    std::any visitUnquotedIdentifier(SqlBaseParser::UnquotedIdentifierContext *context);

    std::any visitQuotedIdentifierAlternative(SqlBaseParser::QuotedIdentifierAlternativeContext *context);

    std::any visitQuotedIdentifier(SqlBaseParser::QuotedIdentifierContext *context);

    std::any visitBackQuotedIdentifier(SqlBaseParser::BackQuotedIdentifierContext *context);
    ...
    std::any visitLegacyDecimalLiteral(SqlBaseParser::LegacyDecimalLiteralContext *context);
    ...
    std::any visitBigDecimalLiteral(SqlBaseParser::BigDecimalLiteralContext *context);

    std::any visitColumnConstraintDefinition(SqlBaseParser::ColumnConstraintDefinitionContext *context);

    std::any visitColumnConstraint(SqlBaseParser::ColumnConstraintContext *context);

    std::any visitTableConstraintDefinition(SqlBaseParser::TableConstraintDefinitionContext *context);
    ...
    std::any visitUniqueConstraint(SqlBaseParser::UniqueConstraintContext *context);

    std::any visitReferenceSpec(SqlBaseParser::ReferenceSpecContext *context);

    std::any visitForeignKeyConstraint(SqlBaseParser::ForeignKeyConstraintContext *context);

    std::any visitConstraintCharacteristic(SqlBaseParser::ConstraintCharacteristicContext *context);

    std::any visitEnforcedCharacteristic(SqlBaseParser::EnforcedCharacteristicContext *context);

    std::any visitRelyCharacteristic(SqlBaseParser::RelyCharacteristicContext *context);

    std::any visitAlterColumnSpecList(SqlBaseParser::AlterColumnSpecListContext *context);

    std::any visitAlterColumnSpec(SqlBaseParser::AlterColumnSpecContext *context);

    std::any visitAlterColumnAction(SqlBaseParser::AlterColumnActionContext *context);
    ...
    std::any visitOperatorPipeRightSide(SqlBaseParser::OperatorPipeRightSideContext *context);

    std::any visitOperatorPipeSetAssignmentSeq(SqlBaseParser::OperatorPipeSetAssignmentSeqContext *context);

    std::any visitAnsiNonReserved(SqlBaseParser::AnsiNonReservedContext *context);

    std::any visitStrictNonReserved(SqlBaseParser::StrictNonReservedContext *context);
